...
`,
  },
  {
    ...
    description: "Dieses Level wird bald freigeschaltet – mit einer besonderen Überraschung im Labyrinth.",
    greeting:
      "Hier wartet noch ein Abenteuer auf dich – Level 5 kommt bald! (Nur im Admin-Vorschau-Modus spielbar.)",
    introSpeech: "Bald geht's hier weiter …",
    rows: [
      "#E########G#",
      "#S#........#",
      "#.#####.#.##",
